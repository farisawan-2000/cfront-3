...
Pname 
templ::type_name(Pexpr actuals) 
{ // obtain type_name associated with an instantiation
  	return (check_actual_args(actuals) 
...
{ // Get past the fake template argument name type_name types
...
Pname
has_templ_instance(Pname fn, Pexpr arg) {
