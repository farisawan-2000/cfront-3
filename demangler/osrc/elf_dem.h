/*ident	"@(#)cls4:tools/demangler/osrc/elf_dem.h	1.3" */
...
/*
   ...
   operating systems,notall of which use ELF, we have set up this
   library so that it may be compiled to work with or without libelf.
   The default is *nameOfThis* to compile for ELF.  Define the macro "ELF" 
